...
$commands = [
  ...
  // команды кнопочные
    ...
    132 => 'подростки',
    133 => 'дети',
    134 => 'обучение преподавателей',
    135 => 'подготовка к экзаменам',
    ...
    909   => 'оставить свой контакт', // вместо этого обрабатываем '_no_text_'
    910   => 'отказаться',
];
...
function keyboard($number){
  ...
  switch ($number) {
    ...
    case 6:
      return [[ ['text' => $commands[907] ],    // отказаться
                ['text' => $commands[906] ] ]]; // начать
    case 7:
      return [[['text' => $commands[908] ]]];   // прекратить
    case 8:
      return [[ ['text' => $commands[909], 'request_contact' => true, ], // оставить контакт
                ['text' => $commands[910] ] ]];                          // отказаться
    case 10: // главная
      return [
    ...
    case 15:
      return [[
          ['text' => $commands[6] ],    // забанить
          ['text' => $commands[121] ]   // завершить общение
      ]]; // начать
  }
}
